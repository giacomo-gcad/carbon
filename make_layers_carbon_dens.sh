...
DIR="/spatial_data/Derived_Datasets/RASTER/Carbon/density/"
...
r.mapcalc --o "gsoc_16_100m_dens = float( gsoc_16_100m / ( area() / 10000))" &
...
r.null map=gsoc_16_100m_dens null=0 &
...
r.out.gdal --o --q input=gsoc_16_100m_dens output=${DIR}gsoc_16_100m_dens.tif createopt="COMPRESS=DEFLATE,BIGTIFF=YES,TILED=YES" -c
...
r.mapcalc --o "gsoc_16_100m_dens_fm = gsoc_16_100m_dens * forest_mask_100m " &
...
r.out.gdal --o --q input=gsoc_16_100m_dens_fm output=${DIR}gsoc_16_100m_dens_fm.tif createopt="COMPRESS=DEFLATE,BIGTIFF=YES,TILED=YES" -c
