...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_lit_carbon;
CREATE TABLE :v_rcep_out.country_lit_carbon AS
SELECT
a.country country_id,a.min lit_min_c_mg_total,a.max lit_max_c_mg_total,a.mean lit_mean_c_mg_total,a.sum/1000000000 lit_tot_c_pg_total,
b.min lit_min_c_mg_prot,b.max lit_max_c_mg_prot,b.mean lit_mean_c_mg_prot,b.sum/1000000000 lit_tot_c_pg_prot,
c.min lit_min_c_mg_unprot,c.max lit_max_c_mg_unprot,c.mean lit_mean_c_mg_unprot,c.sum/1000000000 lit_tot_c_pg_unprot
FROM country_land a 
LEFT JOIN country_land_prot b USING(country)
LEFT JOIN country_land_unprot c USING(country);
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_lit_carbon;
CREATE TABLE :v_rcep_out.ecoregion_lit_carbon AS
SELECT
a.ecoregion eco_id,a.min lit_min_c_mg_total,a.max lit_max_c_mg_total,a.mean lit_mean_c_mg_total,a.sum/1000000000 lit_tot_c_pg_total,
b.min lit_min_c_mg_prot,b.max lit_max_c_mg_prot,b.mean lit_mean_c_mg_prot,b.sum/1000000000 lit_tot_c_pg_prot,
c.min lit_min_c_mg_unprot,c.max lit_max_c_mg_unprot,c.mean lit_mean_c_mg_unprot,c.sum/1000000000 lit_tot_c_pg_unprot
FROM eco_land a 
...
-- pa
DROP TABLE IF EXISTS :v_rcep_out.wdpa_lit_carbon;
CREATE TABLE :v_rcep_out.wdpa_lit_carbon AS
SELECT pa wdpaid,min lit_min_c_mg,max lit_max_c_mg,mean lit_mean_c_mg,sum lit_tot_c_mg FROM pa_land;
