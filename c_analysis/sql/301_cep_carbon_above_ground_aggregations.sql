...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_carbon_above_ground;
CREATE TABLE :v_rcep_out.country_carbon_above_ground AS
SELECT
a.country country_id,a.min agb_min_c_mg_total,a.max agb_max_c_mg_total,a.mean agb_mean_c_mg_total,a.sum/1000000000 agb_tot_c_pg_total,
...
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_carbon_above_ground;
CREATE TABLE :v_rcep_out.ecoregion_carbon_above_ground AS
SELECT
...
-- pa
DROP TABLE IF EXISTS :v_rcep_out.wdpa_carbon_above_ground;
CREATE TABLE :v_rcep_out.wdpa_carbon_above_ground AS
