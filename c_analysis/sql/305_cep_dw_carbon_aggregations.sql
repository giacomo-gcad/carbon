...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS :v_rcep_out.country_dw_carbon;
CREATE TABLE :v_rcep_out.country_dw_carbon AS
SELECT
...
-- ecoregion
DROP TABLE IF EXISTS :v_rcep_out.ecoregion_dw_carbon;
CREATE TABLE :v_rcep_out.ecoregion_dw_carbon AS
SELECT
...
-- pa
DROP TABLE IF EXISTS :v_rcep_out.wdpa_dw_carbon;
CREATE TABLE :v_rcep_out.wdpa_dw_carbon AS
