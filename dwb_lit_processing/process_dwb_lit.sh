...
# grass ${CARBON_MAPSET_PATH} --exec ./compute_prec.sh
...
# grass ${CARBON_MAPSET_PATH} --exec ./compute_elev.sh
...
# grass ${CARBON_MAPSET_PATH} --exec ./compute_gez.sh
...
# grass ${CARBON_MAPSET_PATH} --exec ./compute_cross_gep.sh
